...
class Email {
	...
	function __construct($email,$emailConfig=null){
		if (empty($emailConfig)){
			$emailConfig = Frame::getInstance()->config['email'];
		}
		$this->smtp_host = $emailConfig['smtp_host'];
		$this->smtp_user = $emailConfig['smtp_user'];
		$this->smtp_pass = $emailConfig['smtp_pass'];
		$this->from      = $emailConfig['from'];
		$this->fromName  = $emailConfig['fromName'];
		$this->subject   = $emailConfig['subject'];
		$this->content   = $emailConfig['content'];
